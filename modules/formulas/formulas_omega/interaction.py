# ===============================================================
# formulas_omega/interaction.py — Interacción externa (I_ext)
# ===============================================================
#
# Fórmula central (ley del coseno):
#
...
# Variables:
#
#   C1, C2  — coherencias de los dos sistemas que interactúan
#             (escalares en [0, ∞) en la práctica operativa)
#
#   θ       — diferencia de fase entre ambos (radianes)
#             θ = 0      → interferencia constructiva (“love”)
#             θ = π/2    → independencia (ortogonal)
#             θ = π      → interferencia destructiva (“conflict”)
#
#   C_total — coherencia resultante de la interacción
#
# Casos límite:
#
#   θ = 0      →  C_total = C1 + C2
...
#
# Qué hace:
#   Combina coherencias externas (u otros escalares de coherencia)
#   según el ángulo de fase. No “aprende” sesgo: mide la interacción.
#   Soporta un escalar, un par (C1, C2) o una terna (C1, C2, θ),
#   y reducción de varios ítems por acumulación en θ = 0.
#
# ===============================================================
