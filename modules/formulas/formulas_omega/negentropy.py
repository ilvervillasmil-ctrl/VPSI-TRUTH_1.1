# ===============================================================
# formulas_omega/negentropy.py — Negentropía estructural
# ===============================================================
#
# Fórmula:
#   N = 1 − S / S_max
#
# Donde:
#   S     = entropía del sistema (o de la distribución de capas)
#   S_max = entropía máxima posible del mismo dominio
#   N ∈ [0, 1]
#
#   N → 1  orden / estructura disponible
#   N → 0  saturación / desorden máximo
#
# Se usa en el acoplamiento de capas y en el cálculo de
# coherencia emergente (no es estadística: es magnitud
# estructural del flujo).
#
# ===============================================================
