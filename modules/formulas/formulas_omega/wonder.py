# ======================================================================
#
# WONDER — modules/formulas/formulas_omega/wonder.py
#
# ======================================================================
#
# FÓRMULA
...
#     A = 1 - e^(-N/k)
#
#     N = novedad (experiencias nuevas)
#     k = sensibilidad / saturación
#     A → 1  beginner's mind (asombro pleno)
#     A → 0  cinismo (tóxico estructuralmente)
#
# ======================================================================
#
