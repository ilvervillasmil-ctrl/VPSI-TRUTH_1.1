"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/astronomia.py

Disciplina: astronomia (categoría conocimiento_humano / bloque naturales).
...
FUNCION = {
    "nombre": "astronomia",
    "hace": (
        "Traer y etiquetar material de astronomía y astrofísica; "
    ...
    "o_evaluacion": (
        "Contraste de material astronómico: observaciones, modelos celestes y datos de instrumentos. "
